...
public class AutoTrxDaoImpl implements AutoTrxDao {
	...
	public List<AutoTrxInfoDTO> findAllAutoTransactionInformation() {
		List<AutoTrxInfoDTO> autoTrxList =  jdbcTemplate.query(GET_ALL_AUTO_TRX_INFORMATION, BeanPropertyRowMapper.newInstance(AutoTrxInfoDTO.class));
	...
	public List<AutoTrxInfoDTO> findAutoTransactionsByVehicle(long vehicle_id) {
		List<AutoTrxInfoDTO> autoTrxListVehicle = jdbcTemplate.query(GET_ALL_AUTO_TRX_INFO_BY_VEHICLE, (rs,rowNum) -> 
		new AutoTrxInfoDTO(
				rs.getLong("AUTO_TRANSACTION_ID"),
				rs.getDouble("AMOUNT"),
				rs.getString("AUTO_TRANSACTION_DATE"),
				rs.getString("MAKE"),
				rs.getString("MODEL"),
				rs.getString("YEAR"),
	...
	public List<AutoTrxInfoDTO> findAutoTransactionsByUser(long user_id) {
		List<AutoTrxInfoDTO> autoTrxListUser = jdbcTemplate.query(GET_ALL_AUTO_TRX_BY_USER, (rs,rowNum) -> 
			new AutoTrxInfoDTO(
					rs.getLong("AUTO_TRANSACTION_ID"),
					rs.getDouble("AMOUNT"),
					rs.getString("AUTO_TRANSACTION_DATE"),
	...
	public List<AutoTrxInfoDTO> findAutoTransactionsByType(long transaction_type_id) {
		List<AutoTrxInfoDTO> autoTrxListType = jdbcTemplate.query(GET_ALL_AUTO_TRX_INFO_BY_TYPE, (rs,rowNum) -> 
				new AutoTrxInfoDTO(
						rs.getLong("AUTO_TRANSACTION_ID"),
						rs.getDouble("AMOUNT"),
						rs.getString("AUTO_TRANSACTION_DATE"),
	...
	public ResponseEntity<AutoTrxInfoDTO> findAutoTranasctionInformationById(@PathVariable long auto_transaction_id)
		...
		AutoTrxInfoDTO autoTrxInfo = jdbcTemplate.queryForObject(GET_AUTO_TRX_INFO_BY_ID, BeanPropertyRowMapper.newInstance(AutoTrxInfoDTO.class), auto_transaction_id);
