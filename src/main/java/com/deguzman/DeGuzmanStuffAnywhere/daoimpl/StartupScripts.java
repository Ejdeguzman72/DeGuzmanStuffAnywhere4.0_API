...
public class StartupScripts {
	...
	public String INSERT_EXERCISE_TYPES = "INSERT INTO EXERCISE_TYPES(EXERCISE_TYPE_NAME) VALUES('Abs', 'Back', 'Biceps', 'Chest', 'Delts','Legs', 'Shoulders','Triceps')";
	...
	public String INSERT_TRANSACTION_TYPES = "INSERT INTO TRANSACTION_TYPE(TRANSACTION_TYPE_DESCR) VALUES('RENT','GAS','CABLE','ELECTRIC','INTERNET','PHONES','INTERNET','MORTGAGE','INSURANCE - HOMEOWNERS','INSRUANCE - AUTOMOBILE','INSRUANCE - LIFE','GROCERIES','RESTAURANT','SCHOOL SUPPLIES','SOCIAL','VACATION','AUTO - OIL CHANGE','AUTO - BRAKES','AUTO - BODY WORK','AUTO - TIRES','AUTO - CAR DETAILS','AUTO - GENEAL MAINTENANCE',' AUTO - CRASH MAINTENANCE','MEDICAL - COPAY','MEDICAL - PRESCRIPTION', 'MEDICAL - HOSPITAL BILLS')";
