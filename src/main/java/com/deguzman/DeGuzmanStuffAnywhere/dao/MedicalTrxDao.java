...
public interface MedicalTrxDao {
	...
	public ResponseEntity<MedicalTrxInfoDTO> findMedicalTransactionInformationById(@PathVariable long medical_transaction_id) throws ResourceNotFoundException;
	
	public long getCountOfMedicalTransactions();
	
	public int addMedicalTransactionInformation(@RequestBody MedicalTransaction medicalTransaction) throws ResourceNotFoundException;
	
	public int updateMedicalTransaction(@PathVariable long medicalTransactionId,@RequestBody MedicalTransaction medicalTransactionDetails);
