...
public interface GeneralTrxDao {
	...
	public GeneralTrxInfoDTO findTransactionInformationDTOById(@PathVariable long transaction_id)
			throws ResourceNotFoundException;
	
	public GeneralTransaction findTransactionInformationById(@PathVariable long transaction_id)
			throws ResourceNotFoundException;
